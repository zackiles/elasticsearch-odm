...
module.exports = {
  ...
  findOne: function(match, queryOptions) {
    ...
    var self = this;
    queryOptions.sort = '-createdOn';
    if (queryOptions.fields) queryOptions.fields = _.isArray(queryOptions.fields) ? fields : [queryOptions.fields];
  ...
  findOneAndRemove: function(match, queryOptions, options) {
    ...
    return self.findOne(match, queryOptions).then(function(results) {
      return results ? self.remove(results.id, options) : void 0;
    });
  },
