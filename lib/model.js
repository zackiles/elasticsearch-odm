...
Model.prototype.toObject = function() {
  ...
  if (this.constructor.model.schema) {
    var clonedObject = cloneSchemaProperties(this.constructor.model.schema.fields, this)
    clonedObject.createdOn = this.createdOn;
    clonedObject.updatedOn = this.updatedOn;
    return clonedObject
  }
